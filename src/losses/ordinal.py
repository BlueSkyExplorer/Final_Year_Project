...
def distance_aware_loss(logits, targets, num_classes: int = 4, alpha: float = 1.0):
    # logits expected to be of shape [B, num_classes] or [B, num_classes - 1]
    return ordinal_utils.distance_aware_loss(logits, targets, num_classes, alpha=alpha)
